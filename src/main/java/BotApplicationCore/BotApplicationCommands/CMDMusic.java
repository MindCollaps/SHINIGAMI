...
import BotApplicationCore.AudioCore.AudioInfo;
import BotApplicationCore.AudioCore.PlayerSendHandler;
import BotApplicationCore.AudioCore.TrackManager;
...
public class CMDMusic implements Command {
    ...
    private void add(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
    ...
    private void skip(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
        if (isIdle(guild)) {
            return;
        }
    ...
    private void stop(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
        if (isIdle(guild)) {
            return;
        }
    ...
    private void shuffle(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
        if (isIdle(guild)) {
            return;
        }
    ...
    private void info(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
        if (isIdle(guild)) {
            return;
        }
    ...
    private void showQueue(String[] args, GuildMessageReceivedEvent event, BotApplicationServer server, BotApplicationUser user, Engine engine) {
        if (isIdle(guild)) {
            return;
        }
